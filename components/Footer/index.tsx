...
export default function Footer() {
  return (
    <footer className="relative">
      <div className="relative px-4 md:px-6 bg-black bg-gradient-to-b from-gray-900 to-black">
              ...
              <div className="mt-3 grid space-y-3 text-sm">
                ...
                <p>
                  <a
                    ...
                    href="#"
                  >
                    Package intermédiaire - Business
                  </a>
                </p>
                <p>
                  <a
          ...
          <div className="py-5 mt-5 border-t border-gray-200 dark:border-gray-700">
            <div className="sm:flex sm:justify-between sm:items-center">
              <div className="flex items-center gap-x-3">
                Développé par l&apos;équipe de Lunion-Lab
              </div>
